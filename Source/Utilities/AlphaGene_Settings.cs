...
namespace Adjustable_Ability_Cooldowns.Utilities
{
    public static class AlphaGene_Settings
    {
        ...
        public static void Draw(Listing_Standard listing_Standard)
        {
            ...
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Detonation (" + abilityAG_Detonation + ") Hours", ref abilityAG_Detonation, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddHorizontalLine();
            listing_Standard.Label("Mechanitor abilities");
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Mech IFF scrambler (" + abilityAG_MechConversion + ") Hours", ref abilityAG_MechConversion, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Bandwidth loop (" + abilityAG_BandwidthLoop + ") Hours", ref abilityAG_BandwidthLoop, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Summon band node (" + abilityAG_SummonTempBandwidth + ") Days", ref abilityAG_SummonTempBandwidth, 0, 120, "0", "120", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Summon militor (" + abilityAG_SummonMilitor + ") Hours", ref abilityAG_SummonMilitor, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Summon tesseron (" + abilityAG_SummonTesseron + ") Hours", ref abilityAG_SummonTesseron, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Summon centipede (" + abilityAG_SummonCentipede + ") Hours", ref abilityAG_SummonCentipede, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddHorizontalLine();
            ...
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Mineral overdrive (" + abilityAG_MineralOverdriveA + ") Hours", ref abilityAG_MineralOverdriveA, 0, 24, "0", "24", 0.25f);
            ...
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Zap (" + abilityAG_Zap + ") Hours", ref abilityAG_Zap, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Greater Fire Spew (" + abilityAG_GreaterFireSpew + ") Days", ref abilityAG_GreaterFireSpew, 0, 15, "0", "15", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Greater Acidic Vomit (" + abilityAG_GreaterAcidicVomit + ") Days", ref abilityAG_GreaterAcidicVomit, 0, 15, "0", "15", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Petrifying Gaze (" + abilityAG_PetrifyingGaze + ") Days", ref abilityAG_PetrifyingGaze, 0, 15, "0", "15", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Web (" + abilityAG_Web + ") Hours", ref abilityAG_Web, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Insanity Blast (" + abilityAG_InsanityBlast + ") Hours", ref abilityAG_InsanityBlast, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Sterilizing Breath (" + abilityAG_SterilizingBreath + ") Hours", ref abilityAG_SterilizingBreath, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Banshee Scream (" + abilityAG_BansheeScream + ") Hours", ref abilityAG_BansheeScream, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Freezing Breath (" + abilityAG_FreezingBreath + ") Hours", ref abilityAG_FreezingBreath, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Noxious Breath (" + abilityAG_NoxiousBreath + ") Hours", ref abilityAG_NoxiousBreath, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddHorizontalLine();
            listing_Standard.Label("Stingers abilities");
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Insect Stinger (" + abilityAG_InsectStinger + ") Days", ref abilityAG_InsectStinger, 0, 15, "0", "15", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Insect Stinger Endogenes (" + abilityAG_InsectStingerEndogenes + ") Days", ref abilityAG_InsectStingerEndogenes, 0, 15, "0", "15", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Parasitic Stinger (" + abilityAG_ParasiticStinger + ") Days", ref abilityAG_ParasiticStinger, 0, 15, "0", "15", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Parasitic Stinger Endogenes (" + abilityAG_ParasiticStingerEndogenes + ") Days", ref abilityAG_ParasiticStingerEndogenes, 0, 15, "0", "15", 0.25f);
            listing_Standard.AddHorizontalLine();
            listing_Standard.Label("Summons abilities");
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Minor summon (" + abilityAG_MinorSummon + ") Hours", ref abilityAG_MinorSummon, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Summon (" + abilityAG_Summon + ") Hours", ref abilityAG_Summon, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Major summon (" + abilityAG_MajorSummon + ") Hours", ref abilityAG_MajorSummon, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddHorizontalLine();
            ...
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Unstable mutation (" + abilityAG_UnstableMutation + ") Hours", ref abilityAG_UnstableMutation, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Insect rally (" + abilityAG_InsectRally + ") Hours", ref abilityAG_InsectRally, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Unstable mind (" + abilityAG_UnstableMind + ") Hours", ref abilityAG_UnstableMind, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Devour brains (" + abilityAG_DevourBrains + ") Hours", ref abilityAG_DevourBrains, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Gene syphon (" + abilityAG_GeneSyphon + ") Hours", ref abilityAG_GeneSyphon, 0, 24, "0", "24", 0.25f);
            ...
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Unstable regeneration (" + abilityAG_UnstableRegeneration + ") Hours", ref abilityAG_UnstableRegeneration, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Adaptive biology (" + abilityAG_AdaptiveBiology + ") Hours", ref abilityAG_AdaptiveBiology, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Super adaptive biology (" + abilityAG_SuperAdaptiveBiology + ") Hours", ref abilityAG_SuperAdaptiveBiology, 0, 24, "0", "24", 0.25f);
            ...
            listing_Standard.AddLabeledSlider("Cooldown for the ability: Speed burst (" + abilityAG_SpeedBurst + ") Hours", ref abilityAG_SpeedBurst, 0, 24, "0", "24", 0.25f);
            listing_Standard.AddHorizontalLine();
